...
{
    [TabGroup("Panles")]
    public Color PanelTitle;
    [TabGroup("Panles")]
    public Color PanelInfo;


    [TabGroup("Graphs")]
    public Color GraphAxis;
    [TabGroup("Graphs")]
    public Color GraphAxisTitle;
    [TabGroup("Graphs")]
    public Color GraphAxisLabel;
    [TabGroup("Graphs")]
    public Color GraphCurrentLap;
    [TabGroup("Graphs")]
    public Color GraphLastLap;
    [TabGroup("Graphs")]
